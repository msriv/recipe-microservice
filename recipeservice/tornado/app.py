...
def make_recipeservice_app(
    ...
    app = tornado.web.Application(
            [
                (RECIPE_REGEX, RecipeRequestHandler, dict(service=service, config=config)), # noqa
                (RECIPE_ENTRY_REGEX, RecipeEntryRequestHandler, dict(service=service, config=config)) # noqa
            ],
